# 안녕하세요, 시스템의 안정성과 성능을 높이는 백엔드 개발자 김형곤입니다.

**"레거시를 넘어 견고하고 모던한 아키텍처를 설계합니다."**

공공기관(B2G) 대상 메일 서비스 전문 기업에서 레거시 시스템을 모던 아키텍처로 전환하고 인프라를 고도화하는 작업을 주도해왔습니다. 
Java 17, Spring Boot 기반의 백엔드 개발뿐만 아니라, Elasticsearch를 활용한 검색 엔진 최적화, Elastic Stack을 이용한 풀스택 모니터링 환경 구축 등 인프라와 애플리케이션의 경계를 넘어 시스템 전반의 성능과 품질을 개선하는 일에 집중합니다.
...
### 1. [kotlin-smtp](https://github.com/Hgon86/kotlin-smtp) (현재 진행 및 배포 중)
- 메일 서비스 회사에서의 도메인 지식과 실무 경험을 바탕으로 직접 구현한 커스텀 SMTP 서버 구축 Starter 라이브러리
- **`Tech`**: `Kotlin`, `SMTP`, `WebFlux`, `Coroutine`
### 2. [DochiBot](https://github.com/Hgon86/DochiBot)
- LLM과 문서 검색 엔진을 결합하여 사내/도메인 맞춤형 정보에 대한 정확한 답변을 제공하는 RAG 파이프라인 구축 프로젝트
- **`Tech`**: `Kotlin`, `Spring Boot`, `Spring AI`, `Vector DB`
---
